...
- Header:
includes site name and header region to move the header summery to it later on
- Content:
includes header summery, benefits, explanation, and requirements blocks
- Sidebar Second:
includes all the side bar contents
- Bottom Content:
